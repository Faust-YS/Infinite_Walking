...
public class RedirectionManager : MonoBehaviour {
    ...
    void UpdateCurrentUserState()
    {
        ...
        currPosReal = Utilities.GetRelativePosition(currPos, this.transform) + new Vector3(3f, 0, 0.5f);
    ...
    void UpdatePreviousUserState()
    {
        ...
        prevPosReal = Utilities.GetRelativePosition(prevPos, this.transform) + new Vector3(3f, 0, 0.5f);
    ...
    public void OnResetTrigger()
    {
        ...
        if (resetter != null && /*resetter.IsResetRequired()*/resetter.IsUserNearAndFaceToBound())
        {
